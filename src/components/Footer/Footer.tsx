    ...
    <footer className="pt-10">
      ...
      linear-gradient(rgba(51, 33, 29, 0.9), rgba(51, 33, 29, 0.9)), url(${bg})`,
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-secondary px-5 pt-15 pb-10 gap-6 space-y-5">
          {/* Get In touch */}
          <div>
            <h4 className="uppercase text-xl mb-4 font-semibold">
              Get In Touch
            </h4>
            {getList.map((item) => (
              <span
        ...
        <div className="flex justify-center items-center border-t-2 border-secondary/20 px-8">
          <p className="text-sm py-3 text-center text-secondary/50">
            Copyright 2026 &copy; Kafe Shop - All Right Rserved.{" "}
          </p>
        </div>
      </div>
    </footer>
